...
# 🌐 Load public Hindi translation model
...
try:
    ...
    output_path = "intent_knowledge_base_tagged_translated.json"
    with open(output_path, "w", encoding="utf-8") as f:
        json.dump(tagged_data, f, indent=2, ensure_ascii=False)

    print("✅ Successfully translated all English text into Hindi and saved to intent_knowledge_base_tagged_translated.json")
